...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll" href="#page-top">Shadi.com</a>
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="intro-title mb-4">Shadi.com</h1>
   ...
   <section id="work" class="portfolio-mf sect-pt4 route">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="work-box">
            <a href="img/img12.jpg" data-lightbox="gallery-mf">
              <div class="work-img">
        ...
        <div class="col-md-4">
          <div class="work-box">
            <a href="img/img13.jpg" data-lightbox="gallery-mf">
              <div class="work-img">
                <img src="img/img13.jpg" alt="" class="img-fluid">
              </div>
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
        ...
        <div class="col-md-4">
          <div class="work-box">
            <a href="img/img14.jpg" data-lightbox="gallery-mf">
              <div class="work-img">
                <img src="img/img14.jpg" alt="" class="img-fluid">
              </div>
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
        ...
        <div class="col-md-4">
          <div class="work-box">
            <a href="img/img15.jpg" data-lightbox="gallery-mf">
              <div class="work-img">
                <img src="img/img15.jpg" alt="" class="img-fluid">
              </div>
              <div class="work-content">
                <div class="row">
                 <div class="col-sm-8">
        ...
        <div class="col-md-4">
          <div class="work-box">
            <a href="img/img16.jpg" data-lightbox="gallery-mf">
              <div class="work-img">
                <img src="img/img16.jpg" alt="" class="img-fluid">
              </div>
              <div class="work-content">
                <div class="row">
                  <div class="col-sm-8">
 ...
 <section id="about" class="about-mf sect-pt4 route">
        ...
        <div class="col-sm-12">
          <div class="box-shadow-full">
            <div class="row">
              <div class="col-md-6">
                    <div class="about-img">
                      <img src="img/wed12.jpg" class="img-fluid rounded b-shadow-a" alt="">
                    </div>
  ...
  <div class="testimonials paralax-mf bg-image" style="background-image: url(img/wed12.jpg)">
    <div class="overlay-mf"></div>
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div id="testimonial-mf" class="owl-carousel owl-theme">
            <div class="testimonial-box">
              <div class="author-test">
                <img src="img/pfp2.jpg" alt="" class="rounded-circle b-shadow-a" style="height: 250px; width: 250px;">
                <span class="author">Bride</span>
              </div>
            ...
            <div class="testimonial-box">
              <div class="author-test">
                <img src="img/pfp.jpg" alt="" class="rounded-circle b-shadow-a" style="height: 250px; width: 250px;">
                <span class="author">Kela</span>
              </div>
              <div class="content-test">
                <p class="description lead">
  ...
  <section class="paralax-mf footer-paralax bg-image sect-mt4 route" style="background-image: url(img/wed12.jpg)">
    <div class="overlay-mf"></div>
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
            ...
            <div id="contact" class="box-shadow-full">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="more-info">
                    <p class="lead">
                      Kela Gang headquarter
                     </p>
                    <ul class="list-ico">
                      <li><span class="ion-ios-location"></span>SRM AP, Guntur , Andhra Pradesh</li>
                      <li><span class="ion-ios-telephone"></span> +917386913856</li>
                      <li><span class="ion-email"></span> kelagang@gmail.com</li>
                    </ul>
                  </div>
                  <div class="socials">
                    <ul>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="copyright-box">
              <p class="copyright">&copy; Copyright <strong>Shadi.com</strong>. All Rights Reserved</p>
              <div class="credits">
                <!--
                ...
                -->
                Designed by <a href="#">Kela Gang</a>
              </div>
            </div>
          </div>
        </div>
